...
function Register() {
    ...
    return (
        <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4 py-12 relative overflow-hidden">
            {/* Background glows */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full bg-rose-500/8 blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-sky-500/6 blur-3xl pointer-events-none" />
            {/* Grid pattern */}
            <div
            ...
            <div className="w-full max-w-md relative animate-fade-in">
                ...
                <div className="bg-zinc-950/90 backdrop-blur-xl border border-zinc-800/80 rounded-3xl p-8 shadow-2xl shadow-black/60">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-zinc-400 mt-1 text-sm">Join Nepal's #1 social platform</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="flex flex-col gap-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="group w-full bg-gradient-to-r from-sky-500 to-rose-500 hover:from-sky-400 hover:to-rose-400 text-white font-bold text-base py-4 rounded-2xl mt-2 transition-all shadow-xl shadow-sky-500/25 hover:shadow-sky-500/40 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {loading ? (
                                <>
