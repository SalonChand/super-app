...
function Chat({ themeColor, onStartCall, onlineUsers: onlineUsersProp }) {
    ...
    if (selectedUser) {
        ...
        return (
            <div className="flex flex-col w-full relative bg-zinc-950 sm:h-screen" style={{height: 'calc(100dvh - 52px - env(safe-area-inset-bottom, 0px))'}}>
    ...
    return (
        <div className="flex flex-col w-full bg-black sm:h-screen" style={{height: 'calc(100dvh - 52px - env(safe-area-inset-bottom, 0px))'}}>
            {/* Header */}
