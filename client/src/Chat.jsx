...
function Chat({ themeColor, onStartCall, onlineUsers: onlineUsersProp }) {
    ...
    if (selectedUser) {
        ...
        return (
            <div className="flex flex-col w-full relative bg-zinc-950 h-[calc(100dvh-56px)] sm:h-screen">
    ...
    return (
        <div className="flex flex-col w-full bg-black h-[calc(100dvh-56px)] sm:h-screen">
            {/* Header */}
            <div className="p-4 border-b border-zinc-800 bg-zinc-950/80 sticky top-0 z-10 flex-shrink-0 flex items-center justify-between" style={{paddingTop: 'max(16px, env(safe-area-inset-top))'}}>
